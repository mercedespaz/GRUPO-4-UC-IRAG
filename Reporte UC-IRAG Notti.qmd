...
format:
 html: 
   ...
   toc-depth: 3
   toc-location: left
   css: Data y plantillas/estilo.css
   theme: cerulean
...
source("Scripts/importacion_base_nominal.R")
source("Scripts/Establecimiento.R")
source("Scripts/mapa_efectores.R")
source("Scripts/casos_semanas_epidemiologicas.R")
source("Scripts/grafico_evolucion_UTIP.R")
source("Scripts/grafico_determinaciones_edad.R")
source("Scripts/grafico_determinaciones_se.R")
source("Scripts/comorbilidades.R")
source("Scripts/vacunaVSR.R")
source("Scripts/agrupado.R")
...
<img src="Data y plantillas/Algoritmo.png" alt="Diagrama de flujo del algoritmo" style="width: 70%; max-width: 600px; height: auto; display: block; margin: 0 auto;"/>
:::
