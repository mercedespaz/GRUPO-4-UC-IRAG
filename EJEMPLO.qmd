...
**Gráfico 6.** Cantidad y porcentaje de ingreso a internación por IRAG e IRAGe y otras causas. SE `r semana_min_anio_minimo`/`r anio_minimo` - SE `r semana_max_anio_minimo`/`r anio_maximo`. `r establecimiento` Mendoza. (N= `r int_todas_causas`)
