...
**Figura 1.** Flujograma del circuito de datos de la UC-IRAG, `r establecimiento`.
...
**Gráfico 5.** Antecedentes de vacunación materna contra VSR en menores de 6 meses.SE`r semana_min_anio_minimo`/`r anio_minimo` - SE`r semana_max_anio_minimo`/`r anio_maximo`.`r establecimiento` Mendoza.(N=`r totales`)
...
**Gráfico 6.** Cantidad y porcentaje de ingreso a internación por IRAG e IRAGe. SE`r semana_min_anio_minimo`/`r anio_minimo` - SE`r semana_max_anio_minimo`/`r anio_maximo`. `r establecimiento` Mendoza.(N= `r IRAG_totales_agrupado`)
